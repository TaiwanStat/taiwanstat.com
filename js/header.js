...
(function(window, document, undefined) {
    ...
    str += '<span class="mdl-layout-title"><a href="http://taiwanstat.com/" style="color: #FFF"><img src="/assets/images/round-logo.png" id="round-logo"/>用數據看台灣</a></span>'
    ...
    str += '<span class="mdl-layout-title"><a href="http://taiwanstat.com/"><img src="/assets/images/round-logo.png" id="round-logo"/>用數據看台灣</a></span>'
  ...
  var footer = '<footer class="mdl-mini-footer">'
      ...
      footer += '商業合作提案、客製化圖表製作、意見回饋歡迎來信至: <a href="mailto:contact@taiwanstat.com">contact@taiwanstat.com</a>'
      footer += '</div>'
      footer += '</footer>'
